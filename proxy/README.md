...
3. Namen vergeben, z. B. `sprachkugel-proxy`. Die URL lautet danach
   `https://sprachkugel-proxy.<dein-name>.workers.dev`.
...
```js
const PROXY="https://sprachkugel-proxy.dein-name.workers.dev";
```
...
```
https://abuelia81.github.io/Sprachkugel/domaenen.json
```
